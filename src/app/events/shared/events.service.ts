  ...
  constructor(private http: HttpClient){}
    ...
    saveEvent(event):Observable<IEvent>{
      ...
      return this.http.post<IEvent>('/api/events', event, options).pipe(
        catchError(this.handleError<IEvent>('saveEvents')))
    }
    ...
    searchSessions(searchTerm:string){
      return this.http.get<ISession[]>('api/sessions/search?search='+searchTerm).pipe(
        catchError(this.handleError<ISession[]>('SearchSesions'))
      )
    }
    ...
    imageUrl: ".../assets/basic-shield.png",
      ...
      sessions: [
        ...
        },
        {
          ...
          voters: ['bradgreen', 'igorminar', 'johnpapa', 'bradgreen', 'igorminar', 'martinfowler']
        }
      ]
    },
    {
      ...
      onlineUrl: "https://emmanuelmacharia.herokuapp.com"
      ,
      sessions: [
        {
          id: 1,
